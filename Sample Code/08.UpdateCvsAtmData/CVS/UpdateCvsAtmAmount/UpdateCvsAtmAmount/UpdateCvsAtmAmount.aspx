<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UpdateCvsAtmAmount.aspx.cs" Inherits="SampleCode.UpdateCvsAtmAmount" %>
...
<body>
    <form id="form1" runat="server" style="text-align:center;">
        ...
        <div style="background-color: rgba(128,255,255,0.6); border-radius:5px; text-align:center; padding: 5px; margin:5px;">
            ...
            <p style="text-align:center;">
                <label id="lbVirtualAccount" style="margin:0px 5px;font-weight:600;">
                    <span style="color:red; font-weight:800;">*</span>虛擬帳號
                </label>
                <asp:TextBox ID="tbVirtualAccount" runat="server" style="margin:0px 5px;"></asp:TextBox>
            </p>
            <p style="text-align:center;">
