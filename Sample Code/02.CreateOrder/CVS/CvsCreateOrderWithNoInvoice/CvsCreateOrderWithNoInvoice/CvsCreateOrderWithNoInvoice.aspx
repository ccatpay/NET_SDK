<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CvsCreateOrderWithNoInvoice.aspx.cs" Inherits="SampleCode.CvsCreateOrderWithNoInvoice" %>
...
<body>
    <form id="form1" runat="server" style="text-align:center;">
        ...
        <div style="background-color: rgba(128,255,255,0.6); border-radius:5px; text-align:center; padding: 5px; margin:5px; float: left; ">
            ...
            <p style="text-align:center;">
                <label id="lbExpireDate" style="margin:0px 5px;font-weight:600;">
                    <span style="color:red; font-weight:800;">*</span>繳費到期日(yyyy-MM-dd)
                </label>
                <asp:TextBox ID="tbExpireDate" runat="server" style="margin:0px 5px;" MaxLength="10"></asp:TextBox>
            </p>
            <p style="text-align:center;">
            ...
            <p style="text-align:center;">
                <label id="lbPaymentType" style="margin:0px 5px;font-weight:600;">
                    <span style="color:red; font-weight:800;">*</span>繳費方式
                </label>
                <asp:DropDownList ID="ddlPaymentType" runat="server">
                    <Items>
                       <asp:ListItem Text="請選擇繳費方式" Value="" />
                   </Items>
                </asp:DropDownList>
            </p>
            <p style="text-align:center;">
                <label id="lbPaymentAcquirerType" style="margin:0px 5px;font-weight:600;">
                    <span style="color:red; font-weight:800;">*</span>收單行
                </label>
                <asp:DropDownList ID="ddlPaymentAcquirerType" runat="server">
                    <Items>
     ...
     <div id="InvoiceField" runat="server"
          style="background-color: rgba(128,255,255,0.6); border-radius:5px; text-align:center; padding: 5px; margin:5px; float: left; display:none;">
            ...
            <p style="text-align:center;">
                <label id="lbBuyerInvoiceZip" style="margin:0px 5px;font-weight:600;">買方統編發票寄送郵遞區號</label>
                <asp:TextBox ID="tbBuyerInvoiceZip" runat="server" style="margin:0px 5px;"></asp:TextBox>
            </p>
            <p style="text-align:center;">
                <label id="lbBuyerInvoiceAddr" style="margin:0px 5px;font-weight:600;">買方統編發票寄送地址</label>
                <asp:TextBox ID="tbBuyerInvoiceAddr" runat="server" style="margin:0px 5px;"></asp:TextBox>
            </p>
            <p style="text-align:center;">
