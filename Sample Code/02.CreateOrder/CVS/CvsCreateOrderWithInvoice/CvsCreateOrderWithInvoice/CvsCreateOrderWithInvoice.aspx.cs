                ...
                using (AllCreateOrder WithInvoice = new AllCreateOrder())
                {
                    ...
                    if (enErrors.Count <= 0)
                    {
                        ...
                        if (String.IsNullOrWhiteSpace(token.Error))
                        {
                            ...
                            ReturnCvsOrder returnOrder = WithInvoice.CreateOrder<ReturnCvsOrder , CvsOrderModel, CvsInvoiceModel>(order, invoice);
