            ...
            try
            {
                using (AllCreateOrder NoInvoice = new AllCreateOrder())
                {
                    ...
                    if (String.IsNullOrWhiteSpace(token.Error))
                    {
                        ...
                        ReturnDphOrder returnOrder = NoInvoice.CreateOrder<ReturnDphOrder, DphOrderModel, DphInvoiceModel>(order , invoice);
