<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CocsUnionpayCreateOrderWithNoInvoice.aspx.cs" Inherits="SampleCode.CocsUnionpayCreateOrderWithNoInvoice" %>
...
<body>
    <form id="form1" runat="server" style="text-align:center;">
        ...
        <div style="background-color: rgba(128,255,255,0.6); border-radius:5px; text-align:center; padding: 5px; margin:5px; float: left;">
            ...
            <p style="text-align:center;">
                <label id="lbLimitProductId" style="margin:0px 5px;font-weight:600;">
                    <span style="color:red; font-weight:800;">*</span>限定產品別
                </label>
                <asp:TextBox ID="tbLimitProductId" runat="server" style="margin:0px 5px;" MaxLength="10"></asp:TextBox>
            </p>
            <p style="text-align:center;">
