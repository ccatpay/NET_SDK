...
{
    public partial class RequestCocsCash : Page
    {
        private readonly UtilityProcess _utilityProcess;

        public RequestCocsCash()
        {
            ...
            try
            {
                using (CreditCard creditCard = new CreditCard())
                {
                    ...
                    CocsOrderModel cancel = new CocsOrderModel()
                    {
                        ...
                        /* Credit Card 參數 */
                        , Command = "CocsCashRequest"                                   // 交易代碼 (COCS 指定金額請款 固定帶入 CocsCashRequest)
                    ...
                    if (enErrors.Count <= 0)
                    {
                        ...
                        if (String.IsNullOrWhiteSpace(token.Error))
                        {
                            ...
                            ReturnOrder rtn = creditCard.CocsCashRequest(cancel);
