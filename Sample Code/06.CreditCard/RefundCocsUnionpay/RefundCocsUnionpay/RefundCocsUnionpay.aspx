<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RefundCocsUnionpay.aspx.cs" Inherits="SampleCode.RefundCocsUnionpay" %>
...
<body>
    <form id="form1" runat="server" style="text-align:center;">
        ...
        <div style="background-color: rgba(128,255,255,0.6); border-radius:5px; text-align:center; padding: 5px; margin:5px;">
            ...
            <p style="text-align:center;">
                <label id="lbRefundAmount" style="margin:0px 5px;font-weight:600;">
                    <span style="color:red; font-weight:800;">*</span>取消交易金額
                </label>
                <asp:TextBox ID="tbRefundAmount" runat="server" style="margin:0px 5px;" type="number" max="100000" min="1"></asp:TextBox>
            </p>
            <p style="text-align:center;">
            ...
            <p style="text-align:center;">
                <asp:Button ID="btSubmit" runat="server" Text="取消授權" OnClick="btSubmit_Click"/>
            </p>
        </div>
         <p style="text-align:center;">
