<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UpdateCvsIbonExpireDate.aspx.cs" Inherits="SampleCode.UpdateCvsIbonExpireDate" %>
        ...
        <div style="background-color: rgba(128,255,255,0.6); border-radius:5px; text-align:center; padding: 5px; margin:5px; float: left; ">
            ...
            <p style="text-align:center;">
                <label id="lbExpireDate" style="margin: 0px 5px; font-weight: 600;">
                    <span style="color:red; font-weight:800;">*</span>繳款到期日
                </label>
                <asp:TextBox ID="tbExpireDate" runat="server" style="margin:0px 5px;"></asp:TextBox>
            </p>
            <p style="text-align:center;">
            ...
            <p style="text-align:center;">
                <asp:Button ID="btSubmit" runat="server" Text="變更日期" OnClick="btSubmit_Click"/>
            </p>
        </div>
