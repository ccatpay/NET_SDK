...
{
    public partial class CocsOrderQueryByOrderNo : Page
    {
        private readonly UtilityProcess _utilityProcess;

        public CocsOrderQueryByOrderNo()
        {
        ...
        protected void btSubmit_Click(object sender, EventArgs e)
        {
            ...
            List<ReturnCocsOrder> returnOrderList = new List<ReturnCocsOrder>();
                ...
                using (AllOrderQuery AllQuery = new AllOrderQuery())
                {
                    ...
                    if (enErrors.Count <= 0)
                    {
                        ...
                        if (String.IsNullOrWhiteSpace(token.Error))
                        {
                            ...
                            ReturnCocsOrder returnOrder = AllQuery.OrderQuery<ReturnCocsOrder>(order);
