<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CvsOrderQueryByDate.aspx.cs" Inherits="SampleCode.CvsOrderQueryByDate" %>
...
<body>
    <form id="form1" runat="server" style="text-align:center;">
        ...
        <div style="background-color: rgba(128,255,255,0.6); border-radius:5px; text-align:center; padding: 5px; margin:5px;">
            ...
            <p id="OrderNoField" style="text-align:center;display:none;">
             ...
             <p id="DateField_1" style="text-align:center;">
            ...
            <p id="DateField_2" style="text-align:center;">
        ...
        <asp:GridView ID="gvOrder" runat="server" AutoGenerateColumns="false" PageSize="10"
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="收單行">
                    <ItemTemplate>
                        <div>
                            <%# (Eval("CvsAcquirerType") != null) 
                                ? (!String.IsNullOrWhiteSpace(Eval("CvsAcquirerType").ToString())) 
                                  ? (Enum.GetName(typeof(CCatPay_Net.CvsAcquirerType),Convert.ToInt32(Eval("CvsAcquirerType")))).Equals("esun") 
                                    ? "玉山"
                                    : (Enum.GetName(typeof(CCatPay_Net.CvsAcquirerType),Convert.ToInt32(Eval("CvsAcquirerType")))).Equals("chinatrust") 
                                      ? "中信" : string.Empty
                                  : string.Empty 
                                : string.Empty %>
                        </div>
