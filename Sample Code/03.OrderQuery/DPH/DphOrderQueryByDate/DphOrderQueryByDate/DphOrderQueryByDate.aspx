<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DphOrderQueryByDate.aspx.cs" Inherits="SampleCode.DphOrderQueryByDate" %>
        ...
        <asp:GridView ID="gvOrder" runat="server" AutoGenerateColumns="false" PageSize="10"
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="收單行">
                    <ItemTemplate>
                        <div>
                            <%# (!String.IsNullOrWhiteSpace(Eval("DphAcquirerType").ToString())) 
                                ? (Eval("DphAcquirerType").Equals("opw"))
                                  ? "OPEN錢包"
                                  : (Eval("DphAcquirerType").Equals("icp"))
                                    ? "icashPay" : string.Empty
                                : string.Empty %>
                        </div>
                    </ItemTemplate>
                </asp:TemplateField>
